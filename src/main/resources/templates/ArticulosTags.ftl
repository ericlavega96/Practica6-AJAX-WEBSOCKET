    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <h1 class="my-4">Búsqueda por Tags:
            <small>${tagFind}</small>
          </h1>
          ...
          <ul class="pagination justify-content-center mb-4">
				<#if validP??>
					<li class="page-item">
					  <a class="page-link" href="/busquedaPorTag?page=${prevPage}&tag=${tagFind}">&larr; Older</a>
					</li>
				<#else>
				...
				<#if validN??>
					<li class="page-item">
					  <a class="page-link" href="/busquedaPorTag?page=${nextPage}&tag=${tagFind}">Newer &rarr;</a>
					</li>
				<#else>
					<li class="page-item disabled">
